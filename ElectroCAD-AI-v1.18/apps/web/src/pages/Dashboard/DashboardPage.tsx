  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <section className="overflow-hidden rounded-3xl border bg-white shadow-sm">
        <div className="flex items-center justify-between border-b p-5"><div><h3 className="text-xl font-bold">Assinantes e novos cadastros</h3><p className="text-sm text-slate-500">Todos os usuários cadastrados pela landing page aparecem aqui automaticamente.</p></div><Link to="/subscriptions" className="rounded-xl border px-4 py-2 text-sm font-semibold">Gerenciar planos</Link></div>
